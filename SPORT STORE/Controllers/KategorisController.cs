...
namespace SPORT_STORE.Controllers
{
    ...
    public class KategorisController : Controller
    {
        ...
        {
            return View(db.Kategoris.OrderBy(c=>c.Emri).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Emri")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Emri")] Kategori kategori)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Kategori kategori = db.Kategoris.Find(id);
            foreach(var p in kategori.Produkts)
            {
                p.KategoriID = null;
            }
